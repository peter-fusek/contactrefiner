...
- Cloud Run env vars (as of 2026-03-31): ENABLE_FOLLOWUP_SCORING=true, ENABLE_CRM_SYNC=true, NOTIFICATION_EMAIL, OWNER_EMAIL_PERSONAL, OWNER_EMAIL_WORK, ENVIRONMENT=cloud
