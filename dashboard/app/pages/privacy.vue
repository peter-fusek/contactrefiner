    ...
    <footer class="py-8 px-6 border-t border-neutral-800/50">
      <div class="max-w-5xl mx-auto flex items-center justify-between text-xs text-neutral-600">
        ...
        <div class="flex items-center gap-4">
          ...
          <a href="https://github.com/peter-fusek/contactrefiner" target="_blank" rel="noopener" class="text-neutral-500 hover:text-neutral-400 transition-colors">GitHub</a>
        </div>
      </div>
    </footer>
  </div>
